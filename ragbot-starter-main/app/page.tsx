  ...
  <div className="mt-auto">
    <button onClick={() => setConfigureOpen(true)} className="p-2 rounded-lg hover:bg-blue-700 transition-colors">
      ...
      {/* Main Content */}
        ...
        {/* Chatbot Section */}
        <section className='chatbot-section flex flex-col w-full md:w-[500px] h-[500px] bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-white border-opacity-20 shadow-lg rounded-2xl p-8 md:p-8 m-4 md:m-8'>
